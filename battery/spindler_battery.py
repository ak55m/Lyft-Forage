...
class SpindlerBattery(Car, ABC):
    ...
    #this function returns a bool value for when battery hasn't been service for 2 years
    def battery_should_be_serviced(self):
        return abs(self.obj_last_service_date + self.obj_today_date).days >= 730.5